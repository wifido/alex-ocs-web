    ...
    return angular.module('ocsApp', ['appCtrls', 'appBizs', 'appDirs', 'ngCookies', 'ui.router', 'ui.date', 'base64', 'ngFileUpload', 'ngFileSaver'])
        ...
        .value('SystemConfig', {
            ...
            userRoleRouteMap: {
                ...
                'ROLE_STORE_IMPORTANT': ['main', 'main.orderCreate', 'main.orderList', 'main.orderAudit', 'main.storeCreate', 'main.storeList', 'main.storeManager', 'main.myBill', 'main.billList'],
                'ROLE_BUSINESS_NORMAL': ['main'],
                'ROLE_STORE_NORMAL': ['main', 'main.orderCreate', 'main.orderList', 'main.orderAudit', 'main.storeCreate', 'main.storeList', 'main.myBill', 'main.billList'],
                'ROLE_OTHER' : ['main']
            },
            // 角色按钮映射(小粒度)
            userRoleButtonMap: {
